...
import type { _zetasql_ASTMergeWhenClauseEnums_MatchType } from '../zetasql/ASTMergeWhenClauseEnums';
...
export interface ASTMergeWhenClauseProto {
  ...
  'matchType'?: (_zetasql_ASTMergeWhenClauseEnums_MatchType | keyof typeof _zetasql_ASTMergeWhenClauseEnums_MatchType);
}
