...
import type { _zetasql_ResolvedInsertStmtEnums_InsertMode } from '../zetasql/ResolvedInsertStmtEnums';
...
export interface ResolvedInsertStmtProto {
  ...
  'insertMode'?: (_zetasql_ResolvedInsertStmtEnums_InsertMode | keyof typeof _zetasql_ResolvedInsertStmtEnums_InsertMode);
