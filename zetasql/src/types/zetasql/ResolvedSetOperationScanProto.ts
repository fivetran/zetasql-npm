...
import type { _zetasql_ResolvedSetOperationScanEnums_SetOperationType } from '../zetasql/ResolvedSetOperationScanEnums';
...
export interface ResolvedSetOperationScanProto {
  ...
  'opType'?: (_zetasql_ResolvedSetOperationScanEnums_SetOperationType | keyof typeof _zetasql_ResolvedSetOperationScanEnums_SetOperationType);
