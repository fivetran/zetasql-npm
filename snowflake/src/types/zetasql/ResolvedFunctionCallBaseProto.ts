...
import type { _zetasql_ResolvedFunctionCallBaseEnums_ErrorMode, _zetasql_ResolvedFunctionCallBaseEnums_ErrorMode__Output } from '../zetasql/ResolvedFunctionCallBaseEnums';
...
export interface ResolvedFunctionCallBaseProto__Output {
  ...
  'errorMode': (_zetasql_ResolvedFunctionCallBaseEnums_ErrorMode__Output);
