...
import type { _zetasql_ASTGeneratedColumnInfoEnums_StoredMode } from '../zetasql/ASTGeneratedColumnInfoEnums';

export interface ASTGeneratedColumnInfoProto {
  'parent'?: (_zetasql_ASTNodeProto | null);
  'expression'?: (_zetasql_AnyASTExpressionProto | null);
  'storedMode'?: (_zetasql_ASTGeneratedColumnInfoEnums_StoredMode | keyof typeof _zetasql_ASTGeneratedColumnInfoEnums_StoredMode);
}
