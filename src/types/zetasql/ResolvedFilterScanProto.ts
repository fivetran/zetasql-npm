...
export interface ResolvedFilterScanProto {
  'parent'?: (_zetasql_ResolvedScanProto | null);
  'inputScan'?: (_zetasql_AnyResolvedScanProto | null);
  'filterExpr'?: (_zetasql_AnyResolvedExprProto | null);
}

export interface ResolvedFilterScanProto__Output {
  'parent': (_zetasql_ResolvedScanProto__Output | null);
  'inputScan': (_zetasql_AnyResolvedScanProto__Output | null);
  'filterExpr': (_zetasql_AnyResolvedExprProto__Output | null);
}
