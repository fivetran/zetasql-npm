...
import type { _zetasql_ASTOrderingExpressionEnums_OrderingSpec } from '../zetasql/ASTOrderingExpressionEnums';
...
export interface ASTOrderingExpressionProto {
  ...
  'orderingSpec'?: (_zetasql_ASTOrderingExpressionEnums_OrderingSpec | keyof typeof _zetasql_ASTOrderingExpressionEnums_OrderingSpec);
}
