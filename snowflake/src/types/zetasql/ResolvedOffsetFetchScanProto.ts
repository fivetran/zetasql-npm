...
export interface ResolvedOffsetFetchScanProto {
  ...
  'fetch'?: (_zetasql_AnyResolvedExprProto | null);
}

export interface ResolvedOffsetFetchScanProto__Output {
  ...
  'fetch': (_zetasql_AnyResolvedExprProto__Output | null);
}
