...
import type { ASTGroupingSetsProto as _zetasql_ASTGroupingSetsProto, ASTGroupingSetsProto__Output as _zetasql_ASTGroupingSetsProto__Output } from '../zetasql/ASTGroupingSetsProto';
...
export interface ASTGroupingItemProto {
  ...
  'groupingSets'?: (_zetasql_ASTGroupingSetsProto | null);
...
export interface ASTGroupingItemProto__Output {
  ...
  'groupingSets': (_zetasql_ASTGroupingSetsProto__Output | null);
