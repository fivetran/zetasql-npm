...
import type { _zetasql_ResolvedWindowFrameExprEnums_BoundaryType } from '../zetasql/ResolvedWindowFrameExprEnums';
import type { AnyResolvedExprProto as _zetasql_AnyResolvedExprProto, AnyResolvedExprProto__Output as _zetasql_AnyResolvedExprProto__Output } from '../zetasql/AnyResolvedExprProto';

export interface ResolvedWindowFrameExprProto {
  'parent'?: (_zetasql_ResolvedArgumentProto | null);
  'boundaryType'?: (_zetasql_ResolvedWindowFrameExprEnums_BoundaryType | keyof typeof _zetasql_ResolvedWindowFrameExprEnums_BoundaryType);
