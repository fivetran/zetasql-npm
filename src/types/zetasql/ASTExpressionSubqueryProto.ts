...
import type { _zetasql_ASTExpressionSubqueryEnums_Modifier } from '../zetasql/ASTExpressionSubqueryEnums';
...
export interface ASTExpressionSubqueryProto {
  ...
  'modifier'?: (_zetasql_ASTExpressionSubqueryEnums_Modifier | keyof typeof _zetasql_ASTExpressionSubqueryEnums_Modifier);
}
