...
import type { _zetasql_ResolvedMergeWhenEnums_MatchType, _zetasql_ResolvedMergeWhenEnums_MatchType__Output } from '../zetasql/ResolvedMergeWhenEnums';
import type { AnyResolvedExprProto as _zetasql_AnyResolvedExprProto, AnyResolvedExprProto__Output as _zetasql_AnyResolvedExprProto__Output } from '../zetasql/AnyResolvedExprProto';
import type { _zetasql_ResolvedMergeWhenEnums_ActionType, _zetasql_ResolvedMergeWhenEnums_ActionType__Output } from '../zetasql/ResolvedMergeWhenEnums';
...
export interface ResolvedMergeWhenProto__Output {
  ...
  'matchType': (_zetasql_ResolvedMergeWhenEnums_MatchType__Output);
  'matchExpr': (_zetasql_AnyResolvedExprProto__Output | null);
  'actionType': (_zetasql_ResolvedMergeWhenEnums_ActionType__Output);
