...
import type { _zetasql_ResolvedImportStmtEnums_ImportKind } from '../zetasql/ResolvedImportStmtEnums';
...
export interface ResolvedImportStmtProto {
  ...
  'importKind'?: (_zetasql_ResolvedImportStmtEnums_ImportKind | keyof typeof _zetasql_ResolvedImportStmtEnums_ImportKind);
  'namePath'?: (string)[];
  'filePath'?: (string);
  'aliasPath'?: (string)[];
