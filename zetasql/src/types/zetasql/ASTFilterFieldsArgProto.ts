...
import type { _zetasql_ASTFilterFieldsArgEnums_FilterType } from '../zetasql/ASTFilterFieldsArgEnums';

export interface ASTFilterFieldsArgProto {
  'parent'?: (_zetasql_ASTNodeProto | null);
  'pathExpression'?: (_zetasql_AnyASTGeneralizedPathExpressionProto | null);
  'filterType'?: (_zetasql_ASTFilterFieldsArgEnums_FilterType | keyof typeof _zetasql_ASTFilterFieldsArgEnums_FilterType);
}
