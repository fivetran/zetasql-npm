...
import type { _zetasql_ASTForeignKeyReferenceEnums_Match } from '../zetasql/ASTForeignKeyReferenceEnums';
...
export interface ASTForeignKeyReferenceProto {
  ...
  'match'?: (_zetasql_ASTForeignKeyReferenceEnums_Match | keyof typeof _zetasql_ASTForeignKeyReferenceEnums_Match);
  'enforced'?: (boolean);
}
