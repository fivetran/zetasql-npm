...
export const ResolvedNodeKind = {
  ...
  RESOLVED_TOP_SCAN: 100000,
  RESOLVED_OFFSET_FETCH_SCAN: 100001,
...
export type ResolvedNodeKind =
  ...
  | 'RESOLVED_COLUMN_REF'
  | 6
  | 'RESOLVED_GROUPING_SET_MULTI_COLUMN'
  | 237
  | 'RESOLVED_CONSTANT'
  | 103
  ...
  | 33
  | 'RESOLVED_COLUMN_ANNOTATIONS'
  | 104
  | 'RESOLVED_GENERATED_COLUMN_INFO'
  | 105
  ...
  | 40
  | 'RESOLVED_CREATE_MODEL_ALIASED_QUERY'
  | 226
  ...
  | 64
  | 'RESOLVED_UPDATE_ITEM'
  | 65
  | 'RESOLVED_UPDATE_ARRAY_ITEM'
  | 102
  ...
  | 118
  | 'RESOLVED_SET_OPTIONS_ACTION'
  | 117
  | 'RESOLVED_ALTER_SUB_ENTITY_ACTION'
  | 202
  | 'RESOLVED_ADD_SUB_ENTITY_ACTION'
  | 203
  | 'RESOLVED_DROP_SUB_ENTITY_ACTION'
  | 204
  ...
  | 178
  | 'RESOLVED_ALTER_COLUMN_SET_DATA_TYPE_ACTION'
  | 181
  | 'RESOLVED_ALTER_COLUMN_SET_DEFAULT_ACTION'
  | 198
  | 'RESOLVED_ALTER_COLUMN_DROP_DEFAULT_ACTION'
  | 199
  ...
  | 135
  | 'RESOLVED_RESTRICT_TO_ACTION'
  | 193
  | 'RESOLVED_ADD_TO_RESTRICTEE_LIST_ACTION'
  | 194
  | 'RESOLVED_REMOVE_FROM_RESTRICTEE_LIST_ACTION'
  | 195
  ...
  | 76
  | 'RESOLVED_ARGUMENT_DEF'
  | 77
  | 'RESOLVED_ARGUMENT_REF'
  | 78
  ...
  | 79
  | 'RESOLVED_FUNCTION_SIGNATURE_HOLDER'
  | 84
  ...
  | 180
  | 'RESOLVED_AUX_LOAD_DATA_PARTITION_FILTER'
  | 222
  | 'RESOLVED_AUX_LOAD_DATA_STMT'
  | 186
  | 'RESOLVED_TOP_SCAN'
  | 100000
  | 'RESOLVED_OFFSET_FETCH_SCAN'
  | 100001
  | 'RESOLVED_UNDROP_STMT'
  | 227
  | '__ResolvedNodeKind__switch_must_have_default__'
  | -1

export type ResolvedNodeKind__Output = typeof ResolvedNodeKind[keyof typeof ResolvedNodeKind]
