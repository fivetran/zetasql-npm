...
import type { _zetasql_ASTWindowFrameExprEnums_BoundaryType } from '../zetasql/ASTWindowFrameExprEnums';

export interface ASTWindowFrameExprProto {
  'parent'?: (_zetasql_ASTNodeProto | null);
  'expression'?: (_zetasql_AnyASTExpressionProto | null);
  'boundaryType'?: (_zetasql_ASTWindowFrameExprEnums_BoundaryType | keyof typeof _zetasql_ASTWindowFrameExprEnums_BoundaryType);
}
