...
import type { _zetasql_ASTSelectAsEnums_AsMode } from '../zetasql/ASTSelectAsEnums';

export interface ASTSelectAsProto {
  'parent'?: (_zetasql_ASTNodeProto | null);
  'typeName'?: (_zetasql_ASTPathExpressionProto | null);
  'asMode'?: (_zetasql_ASTSelectAsEnums_AsMode | keyof typeof _zetasql_ASTSelectAsEnums_AsMode);
}
