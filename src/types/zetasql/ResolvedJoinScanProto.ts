...
import type { _zetasql_ResolvedJoinScanEnums_JoinType } from '../zetasql/ResolvedJoinScanEnums';
...
export interface ResolvedJoinScanProto {
  ...
  'joinType'?: (_zetasql_ResolvedJoinScanEnums_JoinType | keyof typeof _zetasql_ResolvedJoinScanEnums_JoinType);
