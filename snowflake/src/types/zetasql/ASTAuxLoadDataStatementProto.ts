...
import type { _zetasql_ASTAuxLoadDataStatementEnums_InsertionMode } from '../zetasql/ASTAuxLoadDataStatementEnums';
...
export interface ASTAuxLoadDataStatementProto {
  ...
  'insertionMode'?: (_zetasql_ASTAuxLoadDataStatementEnums_InsertionMode | keyof typeof _zetasql_ASTAuxLoadDataStatementEnums_InsertionMode);
