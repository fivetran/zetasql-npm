...
export interface ResolvedAggregateScanProto {
  ...
  'groupingSetsColumnList'?: (_zetasql_ResolvedColumnRefProto)[];
  'cubeColumnList'?: (_zetasql_ResolvedColumnRefProto)[];
}
...
export interface ResolvedAggregateScanProto__Output {
  ...
  'groupingSetsColumnList': (_zetasql_ResolvedColumnRefProto__Output)[];
  'cubeColumnList': (_zetasql_ResolvedColumnRefProto__Output)[];
}
