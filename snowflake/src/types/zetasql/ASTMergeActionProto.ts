...
import type { _zetasql_ASTMergeActionEnums_ActionType } from '../zetasql/ASTMergeActionEnums';
...
export interface ASTMergeActionProto {
  ...
  'actionType'?: (_zetasql_ASTMergeActionEnums_ActionType | keyof typeof _zetasql_ASTMergeActionEnums_ActionType);
}
