...
import type { _zetasql_ASTSampleSizeEnums_Unit } from '../zetasql/ASTSampleSizeEnums';
...
export interface ASTSampleSizeProto {
  ...
  'unit'?: (_zetasql_ASTSampleSizeEnums_Unit | keyof typeof _zetasql_ASTSampleSizeEnums_Unit);
}
