...
import type { _zetasql_ASTHavingModifierEnums_ModifierKind } from '../zetasql/ASTHavingModifierEnums';

export interface ASTHavingModifierProto {
  'parent'?: (_zetasql_ASTNodeProto | null);
  'expr'?: (_zetasql_AnyASTExpressionProto | null);
  'modifierKind'?: (_zetasql_ASTHavingModifierEnums_ModifierKind | keyof typeof _zetasql_ASTHavingModifierEnums_ModifierKind);
}
