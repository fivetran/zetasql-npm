...
import type { _zetasql_ASTSetOperationEnums_OperationType } from '../zetasql/ASTSetOperationEnums';
...
export interface ASTSetOperationProto {
  ...
  'opType'?: (_zetasql_ASTSetOperationEnums_OperationType | keyof typeof _zetasql_ASTSetOperationEnums_OperationType);
  'distinct'?: (boolean);
}
