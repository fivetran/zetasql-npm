...
import type { _zetasql_ASTColumnPositionEnums_RelativePositionType } from '../zetasql/ASTColumnPositionEnums';

export interface ASTColumnPositionProto {
  'parent'?: (_zetasql_ASTNodeProto | null);
  'identifier'?: (_zetasql_ASTIdentifierProto | null);
  'type'?: (_zetasql_ASTColumnPositionEnums_RelativePositionType | keyof typeof _zetasql_ASTColumnPositionEnums_RelativePositionType);
}
