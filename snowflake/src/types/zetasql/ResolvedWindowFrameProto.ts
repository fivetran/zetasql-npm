...
import type { _zetasql_ResolvedWindowFrameEnums_FrameUnit, _zetasql_ResolvedWindowFrameEnums_FrameUnit__Output } from '../zetasql/ResolvedWindowFrameEnums';
...
export interface ResolvedWindowFrameProto__Output {
  ...
  'frameUnit': (_zetasql_ResolvedWindowFrameEnums_FrameUnit__Output);
