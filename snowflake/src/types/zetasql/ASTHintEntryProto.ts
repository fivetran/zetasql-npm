...
export interface ASTHintEntryProto {
  'parent'?: (_zetasql_ASTNodeProto | null);
  'qualifier'?: (_zetasql_ASTIdentifierProto | null);
  'name'?: (_zetasql_ASTIdentifierProto | null);
  'value'?: (_zetasql_AnyASTExpressionProto | null);
}

export interface ASTHintEntryProto__Output {
  'parent': (_zetasql_ASTNodeProto__Output | null);
  'qualifier': (_zetasql_ASTIdentifierProto__Output | null);
