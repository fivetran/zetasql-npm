...
import type { _zetasql_ResolvedSampleScanEnums_SampleUnit } from '../zetasql/ResolvedSampleScanEnums';
...
export interface ResolvedSampleScanProto {
  ...
  'unit'?: (_zetasql_ResolvedSampleScanEnums_SampleUnit | keyof typeof _zetasql_ResolvedSampleScanEnums_SampleUnit);
