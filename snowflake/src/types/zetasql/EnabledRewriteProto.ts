...
export interface EnabledRewriteProto {
  'key'?: (_zetasql_FunctionSignatureId);
  'value'?: (boolean);
}

export interface EnabledRewriteProto__Output {
  'key': (_zetasql_FunctionSignatureId__Output);
  'value': (boolean);
}
