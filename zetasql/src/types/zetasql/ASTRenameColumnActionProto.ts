...
export interface ASTRenameColumnActionProto {
  'parent'?: (_zetasql_ASTAlterActionProto | null);
  'columnName'?: (_zetasql_ASTIdentifierProto | null);
  'newColumnName'?: (_zetasql_ASTIdentifierProto | null);
  'isIfExists'?: (boolean);
}

export interface ASTRenameColumnActionProto__Output {
  'parent': (_zetasql_ASTAlterActionProto__Output | null);
  'columnName': (_zetasql_ASTIdentifierProto__Output | null);
  'newColumnName': (_zetasql_ASTIdentifierProto__Output | null);
  'isIfExists': (boolean);
}
