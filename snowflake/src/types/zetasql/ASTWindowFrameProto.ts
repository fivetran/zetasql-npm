...
import type { _zetasql_ASTWindowFrameEnums_FrameUnit } from '../zetasql/ASTWindowFrameEnums';
...
export interface ASTWindowFrameProto {
  ...
  'frameUnit'?: (_zetasql_ASTWindowFrameEnums_FrameUnit | keyof typeof _zetasql_ASTWindowFrameEnums_FrameUnit);
}
