...
import type { SignatureArgumentKind as _zetasql_SignatureArgumentKind } from '../zetasql/SignatureArgumentKind';
...
export interface FunctionArgumentTypeProto {
  'kind'?: (_zetasql_SignatureArgumentKind | keyof typeof _zetasql_SignatureArgumentKind);
