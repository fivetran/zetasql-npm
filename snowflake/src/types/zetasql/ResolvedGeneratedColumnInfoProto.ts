...
import type { _zetasql_ResolvedGeneratedColumnInfoEnums_StoredMode, _zetasql_ResolvedGeneratedColumnInfoEnums_StoredMode__Output } from '../zetasql/ResolvedGeneratedColumnInfoEnums';
...
export interface ResolvedGeneratedColumnInfoProto__Output {
  ...
  'storedMode': (_zetasql_ResolvedGeneratedColumnInfoEnums_StoredMode__Output);
}
