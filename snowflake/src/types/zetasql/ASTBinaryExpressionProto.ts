...
import type { _zetasql_ASTBinaryExpressionEnums_Op } from '../zetasql/ASTBinaryExpressionEnums';
import type { AnyASTExpressionProto as _zetasql_AnyASTExpressionProto, AnyASTExpressionProto__Output as _zetasql_AnyASTExpressionProto__Output } from '../zetasql/AnyASTExpressionProto';

export interface ASTBinaryExpressionProto {
  'parent'?: (_zetasql_ASTExpressionProto | null);
  'op'?: (_zetasql_ASTBinaryExpressionEnums_Op | keyof typeof _zetasql_ASTBinaryExpressionEnums_Op);
  'isNot'?: (boolean);
