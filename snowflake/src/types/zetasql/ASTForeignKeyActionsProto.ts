...
export interface ASTForeignKeyActionsProto {
  ...
  'updateAction'?: (_zetasql_ASTForeignKeyActionsEnums_Action | keyof typeof _zetasql_ASTForeignKeyActionsEnums_Action);
  'deleteAction'?: (_zetasql_ASTForeignKeyActionsEnums_Action | keyof typeof _zetasql_ASTForeignKeyActionsEnums_Action);
}
