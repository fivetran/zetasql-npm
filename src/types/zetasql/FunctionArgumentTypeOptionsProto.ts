...
export interface FunctionArgumentTypeOptionsProto {
  'cardinality'?: (_zetasql_FunctionEnums_ArgumentCardinality | keyof typeof _zetasql_FunctionEnums_ArgumentCardinality);
  ...
  'procedureArgumentMode'?: (_zetasql_FunctionEnums_ProcedureArgumentMode | keyof typeof _zetasql_FunctionEnums_ProcedureArgumentMode);
